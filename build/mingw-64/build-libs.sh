...
cd libvorbis-1.3.6
./configure --prefix=$PREFIX --host=x86_64-w64-mingw32 --disable-shared --with-ogg-includes=$PREFIX/include --with-ogg-libraries=$PREFIX/lib CFLAGS='-O3 -ffunction-sections -fdata-sections'
make -j4
make install
cd ..
